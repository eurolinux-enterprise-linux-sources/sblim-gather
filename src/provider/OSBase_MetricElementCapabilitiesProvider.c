 ...
 *
 * Description: Provider for SBLIM Gatherer Metric Element Capabilities
 *
 */
...
CMInstanceMIStub(, OSBase_MetricElementCapabilitiesProvider, _broker, CMNoHook);

/* Association Provider Interface */

static char * _CLASSNAME = "Linux_MetricElementCapabilities";

static char * _LEFTREF = "Linux_MetricServiceCapabilities";
static char * _RIGHTREF = "Linux_MetricService";

static char * _LEFTPROP = "Capabilities";
...
CMAssociationMIStub(, OSBase_MetricElementCapabilitiesProvider, _broker, CMNoHook);
